...
## Quick Install
  Just clone the repo and then, use [Grunt](https://github.com/gruntjs/grunt-cli) to start the server:
  
  	$ git clone https://github.com/indie-hackathon/drawit.git
  	$ cd drawit
...
## More Information
  * Visit us at [d-chat.in](http://www.d-chat.in/).
  
## Team
  * [axelvaldez](https://github.com/axelvaldez)
  * [raiot](https://github.com/raiot)
  * [squisbiz](https://github.com/squisbiz)
